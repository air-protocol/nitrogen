const { getKeyFromPreviousHash,
    getResolvedAcceptance,
    proposalResolvedWithAcceptance } = require('../../src/consumer/proposalHelper')
...
test('proposalResolvedWithAcceptance returns true when an acceptance was taken', () => {
    //Assemble
    const acceptance = {
        'uuid': 'someid',
        'body': {
...
test('proposalResolvedWithAcceptance returns false when no acceptance taken', () => {
    //Assemble
    const acceptance = {
        'uuid': 'someid',
        'body': {
